...
namespace ProyectoFdiV3.Migrations
{
    ...
    [Migration("20250212084731_InitialM")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ProyectoFdiV3.Models.RegistroResultado", b =>
                {
                    ...
                    b.Property<int?>("CompetenciumNavigationIdCom")
                        .HasColumnType("int");

                    b.Property<int?>("DetalleCompetenciumIdDetalle")
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("IdDepNavigationIdDep")
                        .HasColumnType("int");

                    b.Property<int?>("IdDetalleCompetencia")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("CompetenciumNavigationIdCom");

                    b.HasIndex("DetalleCompetenciumIdDetalle");

                    b.HasIndex("IdDepNavigationIdDep");

                    b.ToTable("RegistroResultado");
                });
            ...
            modelBuilder.Entity("ProyectoFdiV3.Models.RegistroResultado", b =>
                {
                    b.HasOne("ProyectoFdiV3.Models.Competencium", "CompetenciumNavigation")
                        .WithMany()
                        .HasForeignKey("CompetenciumNavigationIdCom");

                    b.HasOne("ProyectoFdiV3.Models.DetalleCompetencium", null)
                        .WithMany("RegistrosResultados")
                        .HasForeignKey("DetalleCompetenciumIdDetalle");

                    b.HasOne("ProyectoFdiV3.Models.Deportistum", "IdDepNavigation")
                        .WithMany()
                        .HasForeignKey("IdDepNavigationIdDep");

                    b.Navigation("CompetenciumNavigation");
